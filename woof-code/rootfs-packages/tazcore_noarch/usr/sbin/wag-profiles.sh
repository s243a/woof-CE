...
setupDHCP()
{
	...
	if [ "$HAVEX" = "yes" ]; then
		...
		export Dhcpcd_Progress_Dialog="<window title=\"$L_TITLE_Network_Wizard\" icon-name=\"gtk-network\" resizable=\"false\" width-request=\"500\">
<vbox>
  ...
  <hbox>
   <button>
	...
	(
		...
		DHCPCDLOG="$(dhcpcd -d -I '' $(dhcpcd_dropwait_option) "$INTERFACE" 2>&1)" #121117...
		HAS_ERROR=$?
...
giveNoWPADialog(){
	export NETWIZ_No_WPA_Dialog="<window title=\"$L_TITLE_Puppy_Network_Wizard\" icon-name=\"gtk-dialog-info\" window-position=\"1\" resizable=\"false\">
 <vbox>
  <pixmap icon_size=\"6\">
    <input file stock=\"gtk-dialog-info\"></input>
  </pixmap>
  ...
  <hbox>
	...
	export NETWIZ_WPA_Details_Dialog="<window title=\"$L_TITLE_Puppy_Network_Wizard\" icon-name=\"gtk-info\" window-position=\"1\" resizable=\"false\">
 <vbox>
  <pixmap icon_size=\"5\">
...
buildProfilesWindow()
{
	...
	export NETWIZ_Profiles_Window="<window title=\"$L_TITLE_Puppy_Network_Wizard\" icon-name=\"gtk-network\" resizable=\"false\">
<vbox>
	<hbox>
	...
	<frame  $L_FRAME_Edit_Profile >
		<vbox scrollable=\"true\" height=\"140\" width=\"450\">
			<hbox>
				<vbox>
...
giveErrorDialog(){
	...
	echo "$@" >> $DEBUG_OUTPUT
	[ "$HAVEX" = "yes" ] || return
	export NETWIZ_ERROR_DIALOG="<window title=\"$L_TITLE_Puppy_Network_Wizard\" icon-name=\"gtk-dialog-error\" resizable=\"false\">
 <vbox>
  <pixmap icon_size=\"6\">
...
useIwconfig ()
{
  #(
	...
	if [ "$HAVEX" = "yes" ]; then 
	  export NETWIZ_Connecting_DIALOG="<window title=\"$L_TITLE_Puppy_Network_Wizard\" icon-name=\"gtk-network\" window-position=\"1\" resizable=\"false\">
 <vbox>
...
$L_MESSAGE_No_Wpaconfig_p2"
	...
	if [ "$HAVEX" = "yes" ]; then 
		...
		export NETWIZ_Scan_Progress_Dialog="<window title=\"$L_TITLE_Network_Wizard\" icon-name=\"gtk-network\" resizable=\"false\">
<vbox>
  ...
  #| Xdialog --title "Puppy Ethernet Wizard" --progress "Acquiring WPA connection\n\nThere may be a delay up to 60 seconds." 0 0 20
	...
	if [ "$1" = "wizard" ] && [ "$HAVEX" = "yes" ] ; then
		export NETWIZ_No_WPA_Connection_Dialog="<window title=\"$L_TITLE_Puppy_Network_Wizard\" icon-name=\"gtk-dialog-error\" window-position=\"1\" resizable=\"false\">
 <vbox>
    ...
    <action>EXIT:Details</action>
		...
		if [ "$EXIT" = "Details" ] ; then
		  ...
		  while [ "$EXIT" = "Refresh" ] ; do
		    ...
		    export NETWIZ_WPA_Status_Dialog="<window title=\"$L_TITLE_Puppy_Network_Wizard\" icon-name=\"gtk-network\" window-position=\"1\" resizable=\"false\">
 <vbox>
...
waitForPCMCIA(){
	...
	export NETWIZ_Wait_For_PCMCIA_Dialog="<window title=\"$L_TITLE_Network_Wizard\" window-position=\"1\" resizable=\"false\">
 <progressbar>
...
showScanWindow()
{
	...
	export NETWIZ_Scan_Progress_Dialog="<window title=\"$L_TITLE_Network_Wizard\" window-position=\"1\" resizable=\"false\">
 <progressbar>
...
export NETWIZ_SCAN_ERROR_DIALOG="<window title=\"'"$L_TITLE_Puppy_Network_Wizard"'\" icon-name=\"gtk-dialog-warning\" window-position=\"1\" resizable=\"false\">
 <vbox>
  <pixmap icon_size=\"6\">
