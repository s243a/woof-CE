...
grep -v '^PKG_REPOS_ENABLED' /root/.packages/PKGS_MANAGEMENT > /tmp/petget-proc/pkgs_management_tmp2
mv -f /tmp/petget-proc/pkgs_management_tmp2 /root/.packages/PKGS_MANAGEMENT
