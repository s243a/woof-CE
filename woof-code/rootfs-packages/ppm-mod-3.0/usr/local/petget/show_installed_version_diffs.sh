...
[ ! -s /tmp/petget-proc/petget/filterpkgs.results.installed ] && exit

#120908 "ALREADY INSTALLED" may not be helpful, as the versions may differ. display these...
DIFFVERITEMS=""
for ONEALREADYINSTALLED in `cut -f 1,2,3 -d '|' /tmp/petget-proc/petget/filterpkgs.results.installed`
do
